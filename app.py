...
class NLPApp:
    ...
    def emotion_gui(self):
        ...
        Label0 = Label(self.root,text='Emotion Analysis')
        Label0.pack(pady=(10,20))

        self.emotion_input = Entry(self.root,width=50)
        self.emotion_input.pack(pady=(5,10),ipady=4)

        emotion_btn = Button(self.root,text='Analyze',command=self.do_emotion_analysis)
    ...
    def entity_reco_gui(self):
        ...
        entity_btn = Button(self.root, text='Analyze', command=self.do_entity_analysis)
        entity_btn.pack(pady=(5, 10))
        ...
        label2 = Label(self.root, text='Note: Entity name can be place/person name')
        label2.pack(pady=(150, 10))


    def do_entity_analysis(self):

        text = self.entity_input.get()
        result = self.apio.entity_analysis(text)
